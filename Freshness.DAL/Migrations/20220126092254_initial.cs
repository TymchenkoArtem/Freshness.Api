        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AuthorizationStage = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SignedInDate = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelegramBotCallUsers", x => x.ChatId);
                });

            migrationBuilder.CreateTable(
                name: "TelegramBotOrderUsers",
                columns: table => new
                {
                    ChatId = table.Column<long>(type: "bigint", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TelegramBotOrderUsers", x => x.ChatId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDoneDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Calls_Workers_WorkerId",
                        column: x => x.WorkerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DistrictWorker", x => new { x.DistrictsId, x.WorkersId });
                    table.ForeignKey(
                        name: "FK_DistrictWorker_Districts_DistrictsId",
                        column: x => x.DistrictsId,
                        principalTable: "Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_DistrictWorker_Workers_WorkersId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DistrictWorker_WorkersId",
                table: "DistrictWorker",
                column: "WorkersId");
